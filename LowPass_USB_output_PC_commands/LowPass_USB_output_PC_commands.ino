...
AudioConvert_F32toI16     convertF32toI16_1; 
//AudioConvert_F32toI16     convertF32toI16_2;
...
//AudioConnection_F32       patchCord2(i2s_in, 1, audioEffectLowpassFD_1, 0);    //connect the Right input
...
AudioConnection           patchCord42(convertF32toI16_1, 0, i2s_usb_out, 1);  //right output ("1")

AudioConnection_F32       patchCord11(audioEffectLowpassFD_1, 0, i2s_out, 0);  //connect the Left gain to the Left output
AudioConnection_F32       patchCord12(audioEffectLowpassFD_1, 0, i2s_out, 1);  //connect the Right gain to the Right output
